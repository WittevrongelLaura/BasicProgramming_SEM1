...
# Schrijf een functie ‘print_lijst_getallen’ die deze 3 getallen als parameter binnen 
# krijgt. De functie print een lijst, met het gewenste aantal getallen, af waarbij 
# het eerste getal gelijk is aan de startwaarde en de getallen met de stapgrootte 
